...
The quantum computing layer applies three quantum algorithms to augment the classical pipeline, as implemented in \texttt{quantum\_agent.py} and illustrated in Figure~\ref{fig:quantum_agent_architecture}.
